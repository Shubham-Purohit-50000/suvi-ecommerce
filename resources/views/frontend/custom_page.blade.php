...
<section class="mb-4">
   ...
   <!-- breadcrumb start -->
            ...
            <div class="row align-items-center">
                <div class="col-md-6 pe-lg-5">
                    <div class="banner-section">
                        <img src="{{ asset('public/assets/img/about/ab_banner.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                    </div>
                </div>
                <div class="col-md-6 ps-lg-5 pt-md-0 pt-3">
                    <h4>Our Mission</h4><br>
                    <p>At SUVI, we're redefining the way you shop online. Built on a passion for quality, convenience, and customer satisfaction, we bring you a seamless eCommerce experience that fits right into your lifestyle.</p><br>
                    <p>From the latest trends to everyday essentials, our curated collections are designed to meet your needs—whether you're shopping for fashion, electronics, home goods, or something uniquely you. We partner with trusted brands and emerging creators to ensure every product meets our standards for value and quality.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 ps-lg-5  order-md-2 order-1">
                    <div class="banner-section">
                         <img src="{{ asset('public/assets/img/about/ab_banner.jpg') }}" class="img-fluid blur-up lazyload" alt=""></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="about-page">
        <div class="container">
            <div class="head_text text-center">
                    <h4>Why Choose</h4>
                    <p>It is the dolor sit amet, consectetur adipiscing elit. <br>Sed quis accumsan nisi Ut ut felis congue nisl hendrerit commodo.</p>
                </div>
        </div>
    </section>
        ...
        <section class="service section-b-space pt-0 ">
            <div class="row partition4 " bis_skin_checked="1">
                <div class="col-lg-3 col-md-6" bis_skin_checked="1">
                    <div class="service-block1" bis_skin_checked="1">
                        <div class="service-svg" bis_skin_checked="1">
    ...
    <div class="banner_sec">
        <img src="{{ asset('public/assets/img/about/banner.webp') }}" class="img-fluid blur-up lazyload w-100" alt="">
    </div>
    ...
    <section class="section-b-space become-vendor">
        <div class="container" bis_skin_checked="1">
            ...
            <div class="step-bg" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-lg-4" bis_skin_checked="1">
                        <div class="step-box" bis_skin_checked="1">
                            <div bis_skin_checked="1">
                                <div class="steps" bis_skin_checked="1">1</div>
                                ...
                                <p>Register your business for free and create a product catalogue. Sell under your own
                                    ...
                                    with ease from our Professional Services network.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4" bis_skin_checked="1">
                        <div class="step-box" bis_skin_checked="1">
                            <div bis_skin_checked="1">
                                <div class="steps" bis_skin_checked="1">2</div>
                    ...
                    <div class="col-lg-4" bis_skin_checked="1">
                        <div class="step-box" bis_skin_checked="1">
                            <div bis_skin_checked="1">
                                <div class="steps" bis_skin_checked="1">3</div>
