...
<section class="pt-4 mb-4 d-none">
...
<div class="breadcrumb-section">
    <div class="container">
        <h2>{{ $page->getTranslation('title') }}</h2>
        <nav class="theme-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('home') }}">Home</a>
                </li>
                <li class="breadcrumb-item active">{{ $page->getTranslation('title') }}</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 pe-lg-5">
                <div class="banner-section">
                    <img src="{{ uploaded_asset($content->mission_image) }}" class="img-fluid blur-up lazyload" alt="Our Mission">
                </div>
            </div>
            <div class="col-md-6 ps-lg-5 pt-md-0 pt-3">
                <h4>Our Mission</h4><br>
                @php echo $content->mission_content; @endphp
            </div>
        </div>
    </div>
</section>
...
<section class="about-page">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 pe-lg-5 pt-md-0 pt-3 order-md-1 order-2">
                <h4>Our Vision</h4><br>
                @php echo $content->vision_content; @endphp
            </div>
            <div class="col-md-6 ps-lg-5 order-md-2 order-1">
                <div class="banner-section">
                    <img src="{{ uploaded_asset($content->vision_image) }}" class="img-fluid blur-up lazyload" alt="Our Vision">
                </div>
            </div>
        </div>
    </div>
...
<section class="about-page">
    <div class="container">
        <div class="head_text text-center">
            <h4>{{ $content->why_choose_title }}</h4>
            <p>{{ $content->why_choose_description }}</p>
        </div>
    </div>
</section>
...
<div class="container pt-md-5 pt-4">
    <section class="service section-b-space pt-0">
        <div class="row partition4">
            @foreach($content->why_choose_items as $item)
                <div class="col-lg-3 col-md-6">
                    <div class="service-block1">
                        <div class="service-svg">
                            <!-- You can make these dynamic too if you store SVG paths in your JSON -->
                            @if($loop->index == 0)
                                <!-- SVG for first item -->
...
<div class="banner_sec">
    <img src="{{ uploaded_asset($content->banner_image) }}" class="img-fluid blur-up lazyload w-100" alt="">
</div>

<!-- Business Steps Section -->
<section class="section-b-space become-vendor">
    <div class="container">
        <h4>{{ $content->business_steps_title }}</h4>
        <div class="step-bg">
            <div class="row">
                @foreach($content->business_steps as $step)
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                <div class="steps">{{ $step->number }}</div>
                                <h4>{{ $step->title }}</h4>
...
<section class="mb-4">
    <div class="container">
        <div class="p-4 bg-white rounded shadow-sm overflow-hidden mw-100 text-left">
            @php echo $content->main_content; @endphp
        </div>
    </div>
</section>
